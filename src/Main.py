...
main = tkinter.Tk()
main.title("Detection and classification of  DDOS Attack In IOT Network Environment") #designing main screen
...
font = ('times', 16, 'bold')
title = Label(main, text='Detection and classification of  DDOS Attack In IOT Network Environment')
